...
if pnet.parallel.main(__name__):
    ...
    net = None
    layers = [
    pnet.OrientedPartsLayer(32,8,(6,6),settings=dict(outer_frame = 1,
        ...
        pnet.ExtensionPartsLayer(num_parts = 256, num_components = 5, part_shape = (12,12),lowerLayerShape = (6,6)),
