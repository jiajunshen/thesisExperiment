...
if pnet.parallel.main(__name__):
    ...
    parser.add_argument('num_rotation',metavar='<number of rotations>',type=int,help='number of rotations')
    ...
    print("Inside")
    extensionlayers = [
        pnet.RotExtensionPartsLayer(num_parts = numParts, num_components = numExtensionParts, rotation = num_rotation, part_shape = (extensionPatchSize,extensionPatchSize), lowerLayerShape = (6,6))
    ]
