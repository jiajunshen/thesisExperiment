...
if pnet.parallel.main(__name__):
    ...
    print("Inside")
    extensionlayers = [
        pnet.ExtensionPartsLayer(num_parts = numParts * numExtensionParts, num_components = numExtensionParts, part_shape = (extensionPatchSize,extensionPatchSize), lowerLayerShape = (6,6))
    ]
