...
python trainClassification.py ./plainPartsModel/plainParts_{2}_parts_seed_ /home/jiajun/.mnist/mnistTrainingData.npy /home/jiajun/.mnist/mnistTrainingLabel.npy /project/yaliamit/jiajun-master/plainClassificationModel/plainParts_{2}_pooling_{3}_trainingSize_{6}_classifier_{4}_numOfClass_{5}_testingType_{7}_seed_ /home/jiajun/.mnist/mnistTestingData.npy /home/jiajun/.mnist/mnistTestingLabel.npy {1} {4} {5} /project/yaliamit/jiajun-master/finalResult/plainPartsClassification_{2}_pooling_{3}_trainingSize_{6}_classifier_{4}_numOfClass_{5}_testingType_{7}.npy {3} {6} {7}\" >> bashPlainPartsClassification_{2}_Parts_{3}_pooling_{4}_classifier_{5}_numOfClass_{6}_trainingSize_{7}_classificationType.sbatch && sbatch bashPlainPartsClassification_{2}_Parts_{3}_pooling_{4}_classifier_{5}_numOfClass_{6}_trainingSize_{7}_classificationType.sbatch" ::: 10 ::: 100 200 500 ::: 4 8 ::: svm ::: 0 ::: 10 ::: validation
